...
class jsminTest extends PHPUnit_Framework_TestCase
{
    public function testMinify_1()
    {
        ...
        $expected = file_get_contents(__DIR__.'/../fixtures/min/dojo.min-c.js');
    ...
    public function testMinify_2()
    {
        ...
        $expected = file_get_contents(__DIR__.'/../fixtures/min/ext.min-c.js');
        $this->assertEquals($expected, $result);
    }
    ...
    public function testMinify_3()
    {
        ...
        $expected = file_get_contents(__DIR__.'/../fixtures/min/jquery.min-c.js');
        $this->assertEquals($expected, $result);
    }
    ...
    public function testMinify_4()
    {
        ...
        $expected = file_get_contents(__DIR__.'/../fixtures/min/mootools.min-c.js');
        $this->assertEquals($expected, $result);
    }
    ...
    public function testMinify_5()
    {
        ...
        $expected = file_get_contents(__DIR__.'/../fixtures/min/utf8-with-bom.min-c.js');
        $this->assertEquals($expected, $result);
    }
    ...
    public function testMinify_6()
    {
        ...
        $expected = file_get_contents(__DIR__.'/../fixtures/min/yui.min-c.js');
        $this->assertEquals($expected, $result);
    }
}
